...
`,
  ...
  {
    name: "009_parent_asin.sql",
    sql: `-- The listing a product's variations hang off.
--
...
`,
  ...
  {
    name: "010_improvability_decimal.sql",
    sql: `-- Improvability is a decimal, not an integer.
--
...
`,
  ...
  {
    name: "011_api_usage.sql",
    sql: `-- Rate and spend guards that survive serverless.
--
...
`,
  ...
  {
    name: "012_user_id.sql",
    sql: `-- Multi-user schema, with no login work.
--
...
`,
  ...
  {
    name: "013_supplier_quotes.sql",
    sql: `-- Supplier quotes, and the point of them.
--
...
`,
  ...
  {
    name: "014_opportunity_decimal.sql",
    sql: `-- opportunity_score is a decimal, and the column was an integer.
--
...
`,
  ...
  {
    name: "015_guard_counts_only_real_calls.sql",
    sql: `-- The hourly guard was counting its own refusals.
--
